...
import { Loader2, Gavel, UserPlus, Pencil, RotateCcw, PanelLeftClose, PanelLeftOpen } from "lucide-react";
    ...
    <>
      ...
      <div className="lg:hidden">
        <FloatingChatMobile
          ...
          onAddVerdict={onAddVerdict}
          onRevisedGtm={onRevisedGtm}
        />
      </div>
    </>
  );
...
// Mobile version: floating button that opens a full-screen sheet-like overlay
function FloatingChatMobile({ repo, analysis, gtm, extraVerdicts, onAddVerdict, onRevisedGtm }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-background">
      <div className="flex items-center justify-between border-b border-border/50 px-4 py-3">
        ...
        <Button size="icon" variant="ghost" onClick={() => setOpen(false)} aria-label="Close panel">
          <X className="size-5" />
        </Button>
      </div>
...
// Need to import these for mobile version
